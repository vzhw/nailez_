...
$sql = "SELECT tblelectronics.*,tblbrands.BrandName,tblbrands.id as bid  from tblelectronics join tblbrands on tblbrands.BrandName=tblelectronics.Brand where tblelectronics.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo htmlentities($result->ElecTitle);?></h2>
      </div>
      <div class="col-md-3">
          ...
          <div class="listing_detail_wrap"> 
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane active" id="vehicle-overview">
                ...
                <p><?php echo htmlentities($result->ElecOverview);?></p>
              </div>
...
{ ?>      
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            <div class="product-listing-img"> <a href="details-electronic.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" /> </a>
            </div>
