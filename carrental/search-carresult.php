...
$sql = "SELECT id from tblcars where tblcars.VehiclesBrand=:brand and tblcars.FuelType=:fueltype";
            ...
            <form action="#" method="get">
              <div class="form-group select">
                <select class="form-control">
                  ...
                  <?php $sql = "SELECT * from  tblbrands WHERE Category = 'Car'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<option value="CNG">Electric</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT tblcars.*,tblbrands.BrandName,tblbrands.id as bid  from tblcars join tblbrands on tblbrands.id=tblcars.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
